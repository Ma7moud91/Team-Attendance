...
@Database(entities = [Member::class, Attendance::class, SyncLog::class, InboxMessage::class, AppNotification::class, SupervisorAssignmentHistory::class, AuditLog::class], version = 6, exportSchema = false)
